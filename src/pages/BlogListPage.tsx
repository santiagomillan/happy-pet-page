...
const mockBlogPosts = [
  {
    ...
    excerpt:
      "Dental health is one of the most overlooked aspects of pet care, yet it's crucial for your pet's overall wellbeing.",
    date: "March 15, 2024",
  ...
  },
  {
    ...
    excerpt:
      "Learn to recognize critical signs that require immediate veterinary attention and how to prepare for emergencies.",
  ...
  },
  {
    ...
    excerpt:
      "Everything you need to know about vaccinating your new pet, from core vaccines to optional immunizations.",
  ...
  },
  {
    ...
    excerpt:
      "Maintain your pet's coat, nails, and hygiene with these expert grooming techniques you can do at home.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Pet Health Blog | Expert Veterinary Advice"
        />
        <meta
          property="og:description"
          content="Expert veterinary articles and tips for keeping your pets healthy and happy"
        />
